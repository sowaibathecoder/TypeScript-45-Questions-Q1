...
let favorite_pizza: string [] = ["Pepperoni", "BBQ Chicken", "Cheese"];
...
console.log(`Well, so i like all the pizzas but ${favorite_pizza} it's my favorite pizzas and mostly i like BBQ Chicken pizza. :)`)
