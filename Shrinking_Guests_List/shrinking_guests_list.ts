...
let guests: string [] = ["Sir Shan", "Sir Zia", "Sir Zakir Ali", "Miss Afsari", "Miss Farhat", "Sir Arsalan"];
...
while (guests.length > 2){
    ...
    console.log(`Sorry, Dear ${removedGuests}, Due to limited space, you can't invite for the dinner.`)
};
